...
var boton = document.getElementById("UserFormButton");
...
function habilitarDesabilitarBoton() {
    ...
    if (todosCamposLlenos) {
        ...
        document.getElementById("errorMessageUserForm").style.display = "none";
    } else {
        boton.setAttribute("disabled", "disabled");
        // Muestra el mensaje de error
        document.getElementById("errorMessageUserForm").style.display = "block";
        document.getElementById("errorMessageUserForm").textContent = "Por favor complete todos los campos.";
    }
}
